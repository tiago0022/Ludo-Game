...
QT_MOC_LITERAL(4, 26, 4)
    ...
    "Tile\0movePawn\0\0handlePawn\0safe\0"
};
...
const QMetaObject Tile::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_Tile.data,
...
int Tile::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = safe(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setSafe(*reinterpret_cast< bool*>(_v)); break;
        }
        _id -= 1;
