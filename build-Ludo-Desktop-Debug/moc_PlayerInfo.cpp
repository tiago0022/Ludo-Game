...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PlayerInfo_t, stringdata) + ofs \
...
const QMetaObject PlayerInfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PlayerInfo.data,
      qt_meta_data_PlayerInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlayerInfo.stringdata))
        return static_cast<void*>(const_cast< PlayerInfo*>(this));
